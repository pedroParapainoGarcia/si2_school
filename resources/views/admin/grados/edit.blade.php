                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="paralelo" id="" class="form-control">
                                        <option value="A" {{ $grado->paralelo == 'A' ? 'selected' : '' }}> A
                                        </option>
                                        <option value="B" {{ $grado->paralelo == 'B' ? 'selected' : '' }}> B
                                        </option>
                                        <option value="C" {{ $grado->paralelo == 'C' ? 'selected' : '' }}> C
                                        </option>
                                        <option value="D" {{ $grado->paralelo == 'D' ? 'selected' : '' }}> D
                                        </option>
                                        <option value="E" {{ $grado->paralelo == 'E' ? 'selected' : '' }}> E
                                        </option>
                                    </select>
                                </div>
                            </div>
